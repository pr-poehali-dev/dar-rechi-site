...
const reviews = [
  { name: "Ленар", text: "Хочу выразить огромную благодарность логопеду Людмиле Сергеевне! Обратились с заиканием у сына. Но не думали, что после первого занятия увидим результат. Сейчас сын умеет контролировать свою речь, заикания стало гораздо меньше. Заниматься еще продолжаем. Логопед поделилась методиками работы, поэтому дома мы тоже занимаемся. Очень рекомендую Людмилу Сергеевну как внимательного, знающего и терпеливого специалиста, который действительно любит свое дело и детей!", stars: 5 },
  { name: "Анастасия", text: "Здесь работают специалисты от бога, с призванием и искренней любовью к детям и это самое главное, когда ребенок всегда с собственным желанием идет на занятия и с улыбкой выходит после! Анжелла Ивановна лучший нейропсихолог в Казани, дочь не говорила практически до 4 лет после ее коррекции ребенок начал излагать длинными предложениями свои мысли и речь становится понятней с каждым занятием! Так же Анастасия Якушева сильный целеустремлённый логопед, очень результативно, появился звук р после одного курса! Спасибо что есть такие специалисты!", stars: 5 },
  { name: "Светлана", text: "Хочу выразить огромную благодарность и отметить высокий профессионализм логопеду Лилии. За чуткое отношение к детям, заботу, внимание, индивидуальный подход к каждому ребёнку, доброту и теплоту. Моя дочь с удовольствием ходила на занятия и выполняла домашние задания. За три месяца обучения моя дочь многому научилась, звуки были поставлены, чему мы очень довольны и благодарны Лилии за наши успехи.", stars: 5 },
  { name: "Диана", text: "Обожаю это место 🥰 Высококвалифицированные специалисты, огромные результаты спустя уже три месяца, что четко отметил наш лечащий невролог. Огромное уважение и благодарность чутким и внимательным специалистам — логопеду Анастасии Алексеевне и нейропсихологу Анжеле Ивановне! Низкий поклон и признание, пусть то благо, что вы дали моему ребенку вернётся Вам 🙏 с любовью Ваш, Рамазанчик)", stars: 5 },
];
